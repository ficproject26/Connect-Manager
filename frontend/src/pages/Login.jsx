  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        {/* Quick Demo Access Card (Clean, Polished Vertical Section) */}
        <div style={{
          background: '#ffffff',
          borderRadius: '14px',
          ...
          <div style={{ padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                return (
                  ...
                  >
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <div style={{ fontWeight: 800, fontSize: '0.75rem', color: '#0f172a', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {acc.title}
                      </div>
                      <div style={{ fontSize: '0.64rem', color: '#64748b', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                        {acc.scope}
                      </div>
                    </div>
                  </button>
            ...
            <div style={{
              ...
              <span>Click any tier button above to instantly authenticate.</span>
            </div>
          </div>
        </div>
